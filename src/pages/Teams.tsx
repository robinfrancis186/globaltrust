    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[600px] overflow-hidden -mt-16">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          <div className="text-white max-w-3xl pt-16">
            ...
            <p className="text-xl mb-8 text-slate-100">Meet the innovators shaping the future of digital trust</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12 text-slate-900" style={{ fontFamily: '"Barlow Condensed", serif', fontWeight: '800', textTransform: 'uppercase', fontSize: '2.2rem' }}>Registered Teams</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {teams.map((team, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden border border-slate-100 transition-transform hover:-translate-y-1 hover:shadow-xl duration-300">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold mb-2 text-slate-900">{team.name}</h3>
                  <p className="text-blue-600 font-medium mb-4">{team.country}</p>
                  <h4 className="font-semibold mb-2 text-slate-800">Project:</h4>
                  <p className="text-slate-600 mb-4">{team.project}</p>
                  <h4 className="font-semibold mb-2 text-slate-800">Team Members:</h4>
