...
export default function Loader({
    title = "Loading Global Trust Challenge...",
    ...
    return (
        <div
            className={cn(
                "flex flex-col items-center justify-center gap-8 p-8 fixed inset-0 z-50 bg-white",
                className
            )}
            {...props}
        >
            ...
            >
                ...
                <motion.div
                    ...
                    style={{
                        background: `conic-gradient(from 0deg, transparent 0deg, rgb(59, 130, 246) 90deg, transparent 180deg)`, // Blue-500
                ...
                <motion.div
                    className="absolute inset-0 rounded-full"
                    style={{
                        background: `conic-gradient(from 0deg, transparent 0deg, rgb(139, 92, 246) 120deg, rgba(139, 92, 246, 0.5) 240deg, transparent 360deg)`, // Violet-500
                ...
                <motion.div
                    className="absolute inset-0 rounded-full"
                    style={{
                        background: `conic-gradient(from 180deg, transparent 0deg, rgba(99, 102, 241, 0.6) 45deg, transparent 90deg)`, // Indigo-500
                ...
                <motion.div
                    className="absolute inset-0 rounded-full"
                    style={{
                        background: `conic-gradient(from 270deg, transparent 0deg, rgba(59, 130, 246, 0.4) 20deg, transparent 40deg)`, // Blue-500
            ...
            >
                ...
                <motion.h1
                    className={cn(
                        config.titleClass,
                        "text-slate-900 font-medium tracking-[-0.02em] leading-[1.15] antialiased"
                    )}
                    initial={{ opacity: 0, y: 12 }}
                    animate={{
                        opacity: 1,
                ...
                <motion.p
                    className={cn(
                        ...
                        "text-slate-500 font-normal tracking-[-0.01em] leading-[1.45] antialiased"
                    )}
