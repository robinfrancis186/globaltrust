...
const ChromaGrid = ({
    ...
    return (
        <div
            ...
            className={`relative w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ${className}`}
            style={{
                '--r': `${radius}px`,
                '--x': '50%',
                '--y': '50%'
        ...
        >
            {data.map((c, i) => (
                <article
                    ...
                    className="group relative flex flex-col w-full min-h-[320px] rounded-[20px] overflow-hidden border-2 border-transparent transition-colors duration-300 cursor-pointer"
                    style={{
